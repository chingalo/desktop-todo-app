...
class $CachedProgramsTable extends CachedPrograms
    with TableInfo<$CachedProgramsTable, CachedProgram> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CachedProgramsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  ...
  @override
  List<GeneratedColumn> get $columns => [id, displayName, shortName, cachedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'cached_programs';
  @override
  VerificationContext validateIntegrity(
    Insertable<CachedProgram> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  CachedProgram map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $CachedProgramsTable createAlias(String alias) {
    return $CachedProgramsTable(attachedDatabase, alias);
  }
}

class CachedProgram extends DataClass implements Insertable<CachedProgram> {
  final String id;
  ...
  CachedProgramsCompanion toCompanion(bool nullToAbsent) {
    return CachedProgramsCompanion(
      id: Value(id),
  ...
  factory CachedProgram.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CachedProgram copyWithCompanion(CachedProgramsCompanion data) {
    return CachedProgram(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('CachedProgram(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode => Object.hash(id, displayName, shortName, cachedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CachedProgram &&
          other.id == this.id &&
...
class CachedProgramsCompanion extends UpdateCompanion<CachedProgram> {
  final Value<String> id;
  final Value<String> displayName;
  final Value<String?> shortName;
  final Value<DateTime> cachedAt;
  final Value<int> rowid;
  const CachedProgramsCompanion({
    this.id = const Value.absent(),
  ...
  CachedProgramsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       displayName = Value(displayName);
  static Insertable<CachedProgram> custom({
  ...
  CachedProgramsCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('CachedProgramsCompanion(')
          ..write('id: $id, ')
          ..write('displayName: $displayName, ')
          ..write('shortName: $shortName, ')
          ..write('cachedAt: $cachedAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CachedProgramsTable cachedPrograms = $CachedProgramsTable(this);
  @override
...
typedef $$TodosTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool userId})
    >;
typedef $$CachedProgramsTableCreateCompanionBuilder =
    CachedProgramsCompanion Function({
      required String id,
      required String displayName,
      Value<String?> shortName,
      Value<DateTime> cachedAt,
...
typedef $$CachedProgramsTableUpdateCompanionBuilder =
    CachedProgramsCompanion Function({
      Value<String> id,
      Value<String> displayName,
      Value<String?> shortName,
...
class $$CachedProgramsTableFilterComposer
    extends Composer<_$AppDatabase, $CachedProgramsTable> {
  $$CachedProgramsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CachedProgramsTableOrderingComposer
    extends Composer<_$AppDatabase, $CachedProgramsTable> {
  $$CachedProgramsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CachedProgramsTableAnnotationComposer
    extends Composer<_$AppDatabase, $CachedProgramsTable> {
  $$CachedProgramsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CachedProgramsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CachedProgramsTable,
          ...
          $$CachedProgramsTableOrderingComposer,
          $$CachedProgramsTableAnnotationComposer,
          $$CachedProgramsTableCreateCompanionBuilder,
          $$CachedProgramsTableUpdateCompanionBuilder,
          (
            CachedProgram,
            BaseReferences<_$AppDatabase, $CachedProgramsTable, CachedProgram>,
          ),
          CachedProgram,
          PrefetchHooks Function()
        > {
  $$CachedProgramsTableTableManager(
    _$AppDatabase db,
    $CachedProgramsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CachedProgramsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CachedProgramsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CachedProgramsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
...
typedef $$CachedProgramsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CachedProgramsTable,
      CachedProgram,
...
class $AppDatabaseManager {
  ...
  $$CachedProgramsTableTableManager get cachedPrograms =>
      $$CachedProgramsTableTableManager(_db, _db.cachedPrograms);
}
